...
export default function Podium({ data: { subject, top, totalQuestions } }) {
  ...
  return (
    <>
      ...
      {apparition >= 3 && top.length >= 3 && (
        <div className="absolute min-h-screen w-full overflow-hidden pointer-events-none">
          <div className="spotlight pointer-events-none"></div>{" "}
        </div>
      )}
        ...
        >
            ...
            >
              ...
              <div className="flex h-full w-full flex-col items-center gap-4 rounded-t-md bg-primary pt-6 text-center shadow-2xl">
                ...
                <p className="text-2xl font-bold text-white drop-shadow-lg">
                  {`${top[1].correctAnswers || 0}/${totalQuestions}`}
                </p>
          ...
          >
            ...
            <div className="flex h-full w-full flex-col items-center gap-4 rounded-t-md bg-primary pt-6 text-center shadow-2xl">
              ...
              <p className="text-2xl font-bold text-white drop-shadow-lg">
                {`${top[0].correctAnswers || 0}/${totalQuestions}`}
              </p>
              <p className="text-sm text-gray-200">
                {`(${top[0].points} очков)`}
              </p>
          ...
          {top[2] && (
            ...
            >
              ...
              <div className="flex h-full w-full flex-col items-center gap-4 rounded-t-md bg-primary pt-6 text-center shadow-2xl">
                ...
                <p className="text-2xl font-bold text-white drop-shadow-lg">
                  {`${top[2].correctAnswers || 0}/${totalQuestions}`}
                </p>
                <p className="text-sm text-gray-200">
                  {`(${top[2].points} очков)`}
                </p>
